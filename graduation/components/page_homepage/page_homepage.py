...
class ExampleHomepage(SiPage):
    def __init__(self, *args, **kwargs):
        ...
        self.subtitle.setText("基于PyQt5以及SiliconUI设计的离线检测系统")
        ...
        self.option_card_project.setTitle("图片批量处理")
        self.option_card_project.setFixedSize(218, 218)
        self.option_card_project.setThemeColor("#855198")
        self.option_card_project.setDescription(
            "系统支持批量图片的井盖检测、分类，包括一张图片有多个井盖的情况")  # noqa: E501


        self.option_card_example = ThemedOptionCardPlane(self)
        self.option_card_example.setTitle("视频检测")
        self.option_card_example.setFixedSize(218, 218)
        self.option_card_example.setThemeColor("#7573aa")
        self.option_card_example.setDescription(
            "系统支持检测整个视频（视频-->视频）    支持视频拆分图像逐一筛查（视频-->图片）")  # noqa: E501


        self.management_card = ThemedOptionCardPlane(self)
        self.management_card.setTitle("综合管理")
        self.management_card.setFixedSize(218, 218)
        self.management_card.setThemeColor("#932a48")
        self.management_card.setDescription(
            "系统支持修改识别失误的井盖（准确率约为95%） 标记井盖是否处理完成 用户可以从程序文件夹中自由导出处理结果")  # noqa: E501
        ...
        self.container_for_cards.addWidget(self.management_card)
        ...
        self.titled_widget_group.addTitle("详细说明")
